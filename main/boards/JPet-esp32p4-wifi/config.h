...
#define BOOT_BUTTON_GPIO        GPIO_NUM_30
#define VOLUME_UP_BUTTON_GPIO   GPIO_NUM_32
...
#define DISPLAY_BLACKLIGHT_REFERENCE_PIN GPIO_NUM_26

#define USER_LED_PIN GPIO_NUM_25
